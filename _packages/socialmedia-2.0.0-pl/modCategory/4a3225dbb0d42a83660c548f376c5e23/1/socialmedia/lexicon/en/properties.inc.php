...
$_lang['socialmedia.snippet_limit_desc']                                = 'The number of social media message that will be shown. Default is "5".';
$_lang['socialmedia.snippet_sort_desc']                                 = 'The sort direction of the social media messages. Default is "{"created": "DESC"}".';
$_lang['socialmedia.snippet_tpl_desc']                                  = 'The template of a social media message, this can be a chunk name, @FILE or @INLINE.';
