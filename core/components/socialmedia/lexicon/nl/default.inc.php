...
$_lang['socialmedia.message_activate']                                  = 'Bericht activeren';
$_lang['socialmedia.message_activate_confirm']                          = 'Weet je zeker dat je dit bericht wilt activeren?';
$_lang['socialmedia.message_deactivate']                                = 'Bericht deactiveren';
$_lang['socialmedia.message_deactivate_confirm']                        = 'Weet je zeker dat je dit bericht wilt deactiveren?';
$_lang['socialmedia.messages_activate_selected']                        = 'Geselecteerde berichten activeren';
$_lang['socialmedia.messages_activate_selected_confirm']                = 'Weet je zeker dat je de geselecteerde berichten wilt activeren?';
$_lang['socialmedia.messages_deactivate_selected']                      = 'Geselecteerde berichten deactiveren';
$_lang['socialmedia.messages_deactivate_selected_confirm']              = 'Weet je zeker dat je de geselecteerde berichten wilt deactiveren?';
...
$_lang['socialmedia.label_message_status']                              = 'Actief';
